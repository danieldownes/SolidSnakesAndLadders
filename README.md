...
- Player Vs Bot 
- where you show ui deacoupling from game core logic
...
Setup Game View:
	...
	should be moved to if landing on that place. Eg, Id of a higher or lower place, depending on
	if there is a ladder or snake placed here.
